package com.redhat.examples.dropwizard.hola_dropwizard;

import javax.ws.rs.client.Client;

import com.redhat.examples.dropwizard.hola_dropwizard.resources.GreeterRestResource;
import com.redhat.examples.dropwizard.hola_dropwizard.resources.GreeterSayingFactory;
import com.redhat.examples.dropwizard.hola_dropwizard.resources.HolaRestResource;
...
public class HolaDropwizardApplication extends Application<HolaDropwizardConfiguration> {
    ...
    public void run(final HolaDropwizardConfiguration configuration, final Environment environment) {
        ...
        Client greeterClient = new JerseyClientBuilder(environment).using(
